...
- **集氛围**: [根据三幕位置+集类型判断，如"恐怖压抑"或"暧昧紧张"]
...
|---|------|-------|------|--------|----------|-------------|------------|------------|----------|-----|-----|
| 1 | 0-2s | S-01 Laura卧室 | 全景 | 俯拍+缓推 | 2s | 场景定场 | 环境 | 恐怖压抑 | 暖黄烛光(烛台左前)+冷蓝月光(窗外右补)+暗角压暗 | 蜡烛噼啪 | 低沉弦乐pad起 |
| 2 | 2-4s | S-01 Laura卧室 | 近景 | 正面 | 2s | 主要人物状态 | [人物] | 恐惧不安 | 烛光(镜前主)+月光(窗侧补)+发丝光 | 呼吸加重 | 弦乐渐强 |
| ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... | ... |
...
## Atmosphere 列写法规范
- 2-4 个氛围词，描述该镜头的情绪/感官感受
- 示例: "恐怖压抑" / "暧昧紧张" / "悲伤回忆" / "震惊恍惚" / "平静日常"
- **动态来源**: 根据 Action 内容 + Dialogue 情绪 + 本集节奏曲线(开场hook→推进→cliffhanger) 判断
...
- **动态来源**: 根据 Atmosphere 变化 + 本集节奏曲线分配，开场hook用强音乐，对话段可"无"，cliffhanger渐强
